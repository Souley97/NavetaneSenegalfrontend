...
export interface Matche {
    id: number;
    equipe_local: Equipe; // Now an object instead of a number
    equipe_visiteur: Equipe; // Now an object instead of a number
    date: Date;
    lieu: string;
    created_at?: Date;
    updated_at?: Date;
    resultat?: Resultat; // Now an object instead of a number
}
